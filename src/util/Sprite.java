...
public abstract class Sprite {
    ...
    public static final int UP_RIGHT_DIRECTION = 315;
    public static final int UP_LEFT_DIRECTION = 225;
    public static final int DOWN_RIGHT_DIRECTION = 45;
    public static final int DOWN_LEFT_DIRECTION = 135;
